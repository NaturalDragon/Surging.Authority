...
using Surging.Core.Caching;
 ...
 {
	/// <summary>
	/// OrganizationMenu -IModule接口
	/// </summary>
	[ServiceBundle("api/{Service}")]
	public interface IOrganizationMenuService: IServiceKey
	{
        /// <summary>
        /// 新增
        /// </summary>
        ...
        Task<JsonResponse> Create(OrganizationMenuRequestDto input);
        /// <summary>
        /// 批量新增
        /// </summary>
        /// <param name="input"></param>
        ...
        [Command(Strategy = StrategyType.Injection,Injection = Strategy.BaseStrategy,RequestCacheEnabled = true,InjectionNamespaces = new string[] { InjectionNamespace.JsonResponseNamespaces})]
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<JsonResponse> BatchCreate(OrganizationMenuBatchRequestDto input);
		...
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<PageData> GetPageList(OrganizationMenuPageRequestDto input);
        /// <summary>
        /// 获取详情
        /// </summary>
        /// <param name="input"></param>
        ...
        [Command(Strategy = StrategyType.Injection, Injection = Strategy.MessageStrategy, RequestCacheEnabled = true)]
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<OrganizationMenuQueryDto> GetForModify(EntityQueryRequest input);
        /// <summary>
        /// 修改
        /// </summary>
        /// <param name="input"></param>
        ...
        [Command(Strategy = StrategyType.Injection,Injection = Strategy.BaseStrategy,RequestCacheEnabled = true,InjectionNamespaces = new string[] { InjectionNamespace.JsonResponseNamespaces})]
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<JsonResponse> Modify(OrganizationMenuRequestDto input);
        /// <summary>
        /// 删除
        /// </summary>
        /// <param name="input"></param>
