...
using Surging.Core.Caching;
 namespace MicroService.IModules.Authority
 {
	...
	public interface IRoleMenuService: IServiceKey
	{
        /// <summary>
        /// 新增
        /// </summary>
        ...
        Task<JsonResponse> Create(RoleMenuRequestDto input);
        /// <summary>
        /// 批量新增
        /// </summary>
        /// <param name="input"></param>
        ...
        [Command(Strategy = StrategyType.Injection,Injection = Strategy.BaseStrategy,RequestCacheEnabled = true,InjectionNamespaces = new string[] { InjectionNamespace.JsonResponseNamespaces})]
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<JsonResponse> BatchCreate(RoleMenuBatchRequestDto input);
		...
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<PageData> GetPageList(RoleMenuPageRequestDto input);
        /// <summary>
        /// 获取详情
        /// </summary>
        /// <param name="input"></param>
        ...
        [Command(Strategy = StrategyType.Injection, Injection = Strategy.MessageStrategy, RequestCacheEnabled = true)]
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<RoleMenuQueryDto> GetForModify(EntityQueryRequest input);
        /// <summary>
        /// 修改
        /// </summary>
        /// <param name="input"></param>
        ...
        [Command(Strategy = StrategyType.Injection,Injection = Strategy.BaseStrategy,RequestCacheEnabled = true,InjectionNamespaces = new string[] { InjectionNamespace.JsonResponseNamespaces})]
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<JsonResponse> Modify(RoleMenuRequestDto input);
        /// <summary>
        /// 删除
        /// </summary>
        /// <param name="input"></param>
