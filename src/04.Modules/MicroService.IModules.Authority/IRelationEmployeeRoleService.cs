...
using Surging.Core.Caching;
 ...
 {
	/// <summary>
	/// RelationEmployeeRole -IModule接口
	/// </summary>
	[ServiceBundle("api/{Service}")]
	public interface IRelationEmployeeRoleService: IServiceKey
	{
        /// <summary>
        /// 新增
        /// </summary>
        ...
        Task<JsonResponse> Create(RelationEmployeeRoleRequestDto input);
        /// <summary>
        /// 批量新增
        /// </summary>
        /// <param name="input"></param>
        ...
        [Command(Strategy = StrategyType.Injection,Injection = Strategy.BaseStrategy,RequestCacheEnabled = true,InjectionNamespaces = new string[] { InjectionNamespace.JsonResponseNamespaces})]
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<JsonResponse> BatchCreate(RelationEmployeeRoleBatchRequestDto input);
		...
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<PageData> GetPageList(RelationEmployeeRolePageRequestDto input);
        /// <summary>
        /// 获取详情
        /// </summary>
        /// <param name="input"></param>
        ...
        [Command(Strategy = StrategyType.Injection, Injection = Strategy.MessageStrategy, RequestCacheEnabled = true)]
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<RelationEmployeeRoleQueryDto> GetForModify(EntityQueryRequest input);
        /// <summary>
        /// 修改
        /// </summary>
        /// <param name="input"></param>
        ...
        [Command(Strategy = StrategyType.Injection,Injection = Strategy.BaseStrategy,RequestCacheEnabled = true,InjectionNamespaces = new string[] { InjectionNamespace.JsonResponseNamespaces})]
		[Authorization(AuthType = AuthorizationType.JWT)]
        Task<JsonResponse> Modify(RelationEmployeeRoleRequestDto input);
        /// <summary>
        /// 删除
        /// </summary>
        /// <param name="input"></param>
