...
using MicroService.IRespository.Authority;
 ...
 {
	 public  class RelationEmployeeRoleValidator : AbstractValidator<RelationEmployeeRole>
	 {
        ...
        void BaseValidator()
	     {
			...
			RuleFor(m => m.EmployeeId).NotNull().WithMessage(x=>string.Format(ErrorMessage.IsRequired,"成员Id"));
