...
using System.Text;
 ...
 namespace MicroService.Entity.Authority.Configuration
 {
	...
	/// EmployeeMenu -映射
	/// </summary>
	public class EmployeeMenuConfigruation:EntityMappingConfiguration<EmployeeMenu>
	{
  
         public override void Map(EntityTypeBuilder<EmployeeMenu> b)
			{ 
			   b.ToTable("EmployeeMenu").HasKey(p => p.Id);
