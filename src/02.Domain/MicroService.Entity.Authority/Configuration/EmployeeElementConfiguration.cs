...
using System.Text;
 ...
 namespace MicroService.Entity.Authority.Configuration
 {
	...
	/// EmployeeElement -映射
	/// </summary>
	public class EmployeeElementConfigruation:EntityMappingConfiguration<EmployeeElement>
	{
  
         public override void Map(EntityTypeBuilder<EmployeeElement> b)
			{ 
			   b.ToTable("EmployeeElement").HasKey(p => p.Id);
