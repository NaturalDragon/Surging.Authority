...
namespace MicroService.Core
{
        ...
        where TEntity : class
    {
        ...
        Task<IEnumerable<TResult>> EntitiesByExpressionAsync<TResult, TKey>(Expression<Func<TEntity, bool>> expression,
       ...
       Expression<Func<TEntity, TResult>> selector, Expression<Func<TEntity, Dictionary<object, QueryOrderBy>>> orderBy) where TResult : class;
        ...
        Task<TResult> SingleAsync<TResult>(Expression<Func<TEntity, bool>> predicate,
            Expression<Func<TEntity, TResult>> selector) where TResult:class;
     ...
     // IQueryable<TReadModel> Table<TReadModel>() where TReadModel : class;
        ...
        Task<IEnumerable<TEntity>> WherePaged(PageData pageData,
       Expression<Func<TEntity, bool>> whereLambda, Expression<Func<TEntity, Dictionary<object, QueryOrderBy>>> orderBy);


        Task<IEnumerable<TResult>> WherePaged<TResult>(PageData pageData,
       Expression<Func<TEntity, bool>> whereLambda, Expression<Func<TEntity, TResult>> selector
