...
namespace MicroService.Data.Validation
{
    public class JsonResponse : IJsonResponse
    {
        ...
        public static JsonResponse Create(bool isValid, string errs = null)
        {
            return errs == null
                    ? JsonResponse.Create(isValid, Array.Empty<string>())
                    : JsonResponse.Create(isValid, new string[] { errs });
        }
        public static JsonResponse Create(bool isValid, params string[] errs)
        {
            ...
            if (!isValid)
            {
                ...
                else
                {
                    ...
                    {
                        jsonResponse.Errors.AddError("", err, attemptedValue:null);
                    }
                }
            }
            return jsonResponse;
